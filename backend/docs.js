...
app.listen(port);
console.log(
  `\n📚 Documentation server running at https://gammacairo-deltareward-9000.codio-box.uk:${port}`
);
console.log(
  `📚 OpenAPI UI available at https://gammacairo-deltareward-9000.codio-box.uk:${port}`
);
console.log(
  `📚 OpenAPI spec available at https://gammacairo-deltareward-9000.codio-box.uk:${port}/schemas/openapi.yaml\n`
);
